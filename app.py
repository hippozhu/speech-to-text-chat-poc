...
st.title(f""":rainbow[Finding Norah: Speech-to-Text Chat]""")
...
def find_norah(transcript):
    return 'nora' in transcript.lower()
...
if transcript:
    ...
    with st.chat_message("assistant"):
        ...
        with st.spinner("Determining the best possible answer!") as status:
            ...
            norah_found = find_norah(transcript)
            answer = 'Hello Norah, found you!!' if norah_found else 'unfortunately, no norah found'
